...
export class AuthService {
  ...
  setAuthToken(token: string) {
    this.localStorage.set(this.BEARER_TOKEN, token);
  }
  ...
  getAuthority() {
    return jwt_decode(this.localStorage.get(this.BEARER_TOKEN)).authority;
  }

  getUserID() {
    if(this.localStorage.get(this.BEARER_TOKEN) != null)
      return jwt_decode(this.localStorage.get(this.BEARER_TOKEN)).userID;
    else 
      return null;
  }

  getField() {
    return jwt_decode(this.localStorage.get(this.BEARER_TOKEN)).field;
  }

  getShop() {
    return jwt_decode(this.localStorage.get(this.BEARER_TOKEN)).shop;
  }
