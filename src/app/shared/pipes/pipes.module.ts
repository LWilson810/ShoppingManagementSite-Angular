...
import { FilterAuthorityPipe } from './filter-authority.pipe';
...
import { FilterFieldsShopsPipe } from './filter-fileds-shops.pipe';
import { GroupCommoditiesPipe } from './commodity-group.pipe';
...
@NgModule({
  declarations: [
    FilterAuthorityPipe,
    FilterFieldsPipe,
    FilterFieldsShopsPipe,
    GroupCommoditiesPipe,
    // ImagePipe,
    // DynCurrencyPipe,
